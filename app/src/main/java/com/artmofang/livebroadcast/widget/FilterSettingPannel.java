package com.artmofang.livebroadcast.widget;
...
public class FilterSettingPannel extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
...
//    };
    ...
    public FilterSettingPannel(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray attr = context.obtainStyledAttributes(attrs, R.styleable.settingPanel, 0, 0);
        type = attr.getString(R.styleable.settingPanel_setting_type);
...
//                break;
    ...
    private void setFilter(int index) {
        ...
        switch (index) {
            case 1:
                bmp = decodeResource(getResources(), R.mipmap.filter_langman);
                break;
            case 2:
                bmp = decodeResource(getResources(), R.mipmap.filter_qingxin);
                break;
            case 3:
                bmp = decodeResource(getResources(), R.mipmap.filter_weimei);
                break;
            case 4:
                bmp = decodeResource(getResources(), R.mipmap.filter_fennen);
                break;
            case 5:
                bmp = decodeResource(getResources(), R.mipmap.filter_huaijiu);
                break;
            case 6:
                bmp = decodeResource(getResources(), R.mipmap.filter_landiao);
                break;
            case 7:
                bmp = decodeResource(getResources(), R.mipmap.filter_qingliang);
                break;
            case 8:
                bmp = decodeResource(getResources(), R.mipmap.filter_rixi);
                break;
            default:
                bmp = null;
                break;
